...
namespace HarrisContactWeb.Controllers
{
    public class BusinessContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BusinessContactID,ContactFname,ContactLname,ContactTel,ContactEmail,ContactAddr1,ContactAddr2,ContactCity,ContactPostcode,PersonalTel")] BusinessContact businessContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BusinessContactID,ContactFname,ContactLname,ContactTel,ContactEmail,ContactAddr1,ContactAddr2,ContactCity,ContactPostcode,PersonalTel")] BusinessContact businessContact)
        {
